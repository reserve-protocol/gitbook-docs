...
All Yield DTFs are fully backed by diversified collateral and can be protected against default by [Reserve Rights (RSR) staking](../rsr-reserve-rights.md#staking). Stakers earn a portion of DTF yield in exchange for governance and security.
...
* 🔁 [Minting & redeeming](minting-and-redeeming.md)\
